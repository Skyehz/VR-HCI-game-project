...
public partial class @GameInput: IInputActionCollection2, IDisposable
{
    ...
    private List<IPitcherActions> m_PitcherActionsCallbackInterfaces = new List<IPitcherActions>();
    ...
    public struct PitcherActions
    {
        ...
        public void AddCallbacks(IPitcherActions instance)
        {
            if (instance == null || m_Wrapper.m_PitcherActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PitcherActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPitcherActions instance)
        {
            @Select.started -= instance.OnSelect;
            @Select.performed -= instance.OnSelect;
            @Select.canceled -= instance.OnSelect;
        ...
        public void RemoveCallbacks(IPitcherActions instance)
        {
            if (m_Wrapper.m_PitcherActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPitcherActions instance)
        {
            foreach (var item in m_Wrapper.m_PitcherActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PitcherActionsCallbackInterfaces.Clear();
    ...
    private List<IBatterNRunnerActions> m_BatterNRunnerActionsCallbackInterfaces = new List<IBatterNRunnerActions>();
    ...
    public struct BatterNRunnerActions
    {
        ...
        public void AddCallbacks(IBatterNRunnerActions instance)
        {
            if (instance == null || m_Wrapper.m_BatterNRunnerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BatterNRunnerActionsCallbackInterfaces.Add(instance);
            @Move.started += instance.OnMove;
            @Move.performed += instance.OnMove;
            @Move.canceled += instance.OnMove;
        ...
        private void UnregisterCallbacks(IBatterNRunnerActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(IBatterNRunnerActions instance)
        {
            if (m_Wrapper.m_BatterNRunnerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IBatterNRunnerActions instance)
        {
            foreach (var item in m_Wrapper.m_BatterNRunnerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BatterNRunnerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
